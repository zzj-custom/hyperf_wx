 ...
 * @method static string|null dump($key)
 ...
 * @method static string|null hget($key, $field)
 ...
 * @method static array|null  blpop(array|string $keys, $timeout)
 * @method static array|null  brpop(array|string $keys, $timeout)
 * @method static string|null brpoplpush($source, $destination, $timeout)
 * @method static string|null lindex($key, $index)
 * @method static int         linsert($key, $whence, $pivot, $value)
 * @method static int         llen($key)
 * @method static string|null lpop($key)
 ...
 * @method static string|null rpop($key)
 * @method static string|null rpoplpush($source, $destination)
 ...
 * @method static string|null spop($key, $count = null)
 * @method static string|null srandmember($key, $count = null)
 ...
 * @method static int|null    zrank($key, $member)
 ...
 * @method static int|null    zrevrank($key, $member)
 * @method static int         zunionstore($destination, array|string $keys, array $options = null)
 * @method static string|null zscore($key, $member)
 ...
 * @method static string|null geodist($key, $member1, $member2, $unit = null)
...
class RedisUtil
{
    ...
    public static function lock(string $key, int $seconds): bool
    {
        if (static::setnx($key, 1)) {
    ...
    {
        return static::del([$key]) > 0;
    }

    public static function spinLock(string $key, int $seconds, int $loopMicroSeconds = 1): void
    {
        while (1) {
            if (static::lock($key, $seconds)) {
                break;
            }
            usleep($loopMicroSeconds);
        }
    }
}
